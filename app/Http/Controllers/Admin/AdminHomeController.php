...
class AdminHomeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.home', compact('total_completed_orders','total_revenue','total_pending_orders','total_active_customers','total_pending_customers','total_rooms','total_subscribers','orders'));
    }
}
