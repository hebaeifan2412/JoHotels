        ...
        @foreach($single_room_data->reviews as $review)
            <div class="review-box p-3 mb-3 shadow-sm rounded position-relative" style="background: #F3F3F3; color:#E75542;">
                <div class="d-flex align-items-center">
                    {{-- <img src="{{ asset(path: 'uploads/' . ($review->customer->photo ?? 'default.jpg')) }}" 
                         alt="Customer Image" class="rounded-circle" width="50" height="50" style="object-fit: cover; border: 2px solid white;"> --}}
                    <div class="ms-3">
                ...
                <div class="mt-2">
                    ...
                    @if(Auth::guard('customer')->id() == $review->customer_id)
                        <div class="position-absolute" style="top: 10px; right: 10px;">
                            {{-- <a href="{{ route('review.edit', $review->id) }}" class="btn btn-sm btn-light text-dark me-1">✏️ Edit</a> --}}
...
<!-- Add Review Section -->
@if(Auth::guard('customer')->check() && $hasBooked)
